...
<?php
 echo"<img src='images/$rec[image]' alt='image not found'>" ?>
                                        
                                    </div>
                                    <div class="profile-r align-self-center">

<h3 class="sub-title-w3-agileits"><?= $rec['name'];?></h3>

<a href="mailto:info@example.com"><?=$rec['email'];?></a>
